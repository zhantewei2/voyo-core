...
LoaderComponent = __decorate([
    ...
    `,
        styles: '.voyo-loader-container.__cover{position:absolute;top:0;left:0;height:100%;width:100%;z-index:2}.voyo-load-wrapper,.voyo-loader-container.__inline{display:inline-block}.voyo-load-wrapper.__block{display:flex;justify-content:center;align-items:center;height:5.5em}.voyo-load-wrapper.__block ._img,.voyo-load-wrapper.__block ._img-wrapper{height:5em;width:5em}.voyo-load-wrapper.__block ._view{display:flex;justify-content:center;align-items:center;flex-flow:column}.voyo-load-wrapper.__block ._text{margin:.5rem 0 0}.voyo-load-wrapper.__inline ._view{display:inline-flex;justify-content:center;align-items:center}.voyo-load-wrapper.__inline ._img,.voyo-load-wrapper.__inline ._img-wrapper{height:4em;width:4em}.voyo-load-wrapper.__inline ._textIcon{font-size:2.5em}.voyo-load-wrapper.__inline ._text{margin:0 0 0 .5rem}.voyo-load-wrapper.__abs,.voyo-load-wrapper.__absCenter{position:absolute;z-index:2;text-align:center}.voyo-load-wrapper.__abs{width:100%;left:0;top:0}.voyo-load-wrapper.__absCenter{top:50%;left:50%;transform:translate(-50%,-50%)}.voyo-load-wrapper ._text{color:var(--color-font-des)}.voyo-load-wrapper.__size-mini{font-size:6px}.voyo-load-wrapper.__size-small{font-size:10px}.voyo-load-wrapper.__size-now{font-size:12px}.voyo-load-wrapper.__size-medium{font-size:14px}.voyo-load-wrapper.__size-strong{font-size:16px}.voyo-load-wrapper.__size-large{font-size:20px}@-webkit-keyframes VoyoAnLoading{to{transform:rotate(1turn)}}@keyframes VoyoAnLoading{to{transform:rotate(1turn)}}.voyo-an-loading{-webkit-animation:VoyoAnLoading 1s linear infinite;animation:VoyoAnLoading 1s linear infinite}@-webkit-keyframes VoyoFadeIn{0%{opacity:0;transform:scale3d(.8,.8,.8)}}@keyframes VoyoFadeIn{0%{opacity:0;transform:scale3d(.8,.8,.8)}}@-webkit-keyframes VoyoFadeOut{to{opacity:0;transform:scale3d(.8,.8,.8)}}@keyframes VoyoFadeOut{to{opacity:0;transform:scale3d(.8,.8,.8)}}@-webkit-keyframes VoyoFadeIn0{0%{opacity:0}}@keyframes VoyoFadeIn0{0%{opacity:0}}@-webkit-keyframes VoyoFadeOut0{to{opacity:0}}@keyframes VoyoFadeOut0{to{opacity:0}}.voyo-an-fadeIn{-webkit-animation:VoyoFadeIn .2s cubic-bezier(.09,.34,.48,.97);animation:VoyoFadeIn .2s cubic-bezier(.09,.34,.48,.97)}.voyo-an-fadeOut{-webkit-animation:VoyoFadeOut .2s cubic-bezier(.79,.07,.98,1);animation:VoyoFadeOut .2s cubic-bezier(.79,.07,.98,1);-webkit-animation-fill-mode:forwards;animation-fill-mode:forwards}.voyo-an-fadeIn0{-webkit-animation:VoyoFadeIn0 .2s cubic-bezier(.09,.34,.48,.97);animation:VoyoFadeIn0 .2s cubic-bezier(.09,.34,.48,.97)}.voyo-an-fadeOut0{-webkit-animation:VoyoFadeOut0 .2s cubic-bezier(.79,.07,.98,1);animation:VoyoFadeOut0 .2s cubic-bezier(.79,.07,.98,1)}',
    })
], LoaderComponent);
