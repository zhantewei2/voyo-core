...
let DialogComponent = class DialogComponent extends VoyoComponent {
    ...
    created() {
        ...
        this.displayAnimation = new AnimationDisplay(this.container, "voyo-dialog-animate", "", this.dialogBg);
